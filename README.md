...
This library contains minimalist Rust FFI bindings for libdecor in a way that's
roughly equivalent to the official
[libdecor.h](https://gitlab.freedesktop.org/libdecor/libdecor/-/blob/0.2.2/src/libdecor.h?ref_type=tags)
...
This library is based specifically on libdecor 0.2.2 since that's the version
provided by
